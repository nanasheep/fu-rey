...
cement_aio <- ggplot(cement_avg, aes(x = element, y = avg, color = Cement)) + #attempt at making a single spider plot with all samples
  ...
  theme(
    ...
    legend.background = element_rect(fill = "#878787")
    )
cement_aio
```