...
```{r}
orig_data <- read_xlsx("ree_data_r.xlsx", 1)
rerun_data <- read_xlsx("jan2024 data.xlsx",4)
...
rerun_data <- rerun_data[-1,] %>%
  rename(Sample = 1, Na = 2, Mg  = 3, K = 4, Ca = 5, V = 6, Cr = 7, Fe = 8, Mn = 9, Cu = 10, Zn = 11, Rb = 12, Sr = 13, Y = 14, Mo = 15, Ba = 16, La = 17, Ce = 18, Pr = 19, Nd = 20, Sm = 21, Eu = 22, Gd = 23, Dy = 24, Ho = 25, Er = 26, Tm = 27, Yb = 28, Lu = 29, Pb = 30, U = 31)

dil_data <- dil_data[-1,] %>%
  rename(Sample = 1, Na = 2, Mg  = 3, K = 4, Ca = 5, V = 6, Cr = 7, Fe = 8, Mn = 9, Cu = 10, Zn = 11, Rb = 12, Sr = 13, Y = 14, Mo = 15, Ba = 16, La = 17, Ce = 18, Pr = 19, Nd = 20, Sm = 21, Eu = 22, Gd = 23, Dy = 24, Ho = 25, Er = 26, Tm = 27, Yb = 28, Lu = 29, Pb = 30, U = 31)

all_rerun <- bind_rows(rerun_data, dil_data) %>%
...
```{r combine anomaly data from both runs}
...
## Plots
``` {r orig data spider}
cement_aio <- orig_cement_avg %>% filter(element != "Lu")
