...
```{r compare}
comp <- inner_join(x = dilute_normalize, y = normalize, by = c("Sample" = "Sample"), suffix = c(" dilute", " orig"))

comp <- left_join(x = pivot_longer(dilute_normalize, cols =   La_normal:Lu_normal, names_to = "Element", values_to = "Conc."), y = pivot_longer(normalize, cols = La_normal:Lu_normal, names_to = "Element", values_to = "Conc."), by = c("Sample", "Cement", "Element"), suffix = c(" dilute", " orig"))
```